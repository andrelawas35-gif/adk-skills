---
name: business-design-pricing-and-packaging
default_tier: high
...
Apply the `business-design-pricing-and-packaging` profile in
...
routes, and revisit trigger to `conduct-work-object`.

## Routing and termination

- Market or willingness-to-pay gap -> `business-manage-market-intelligence`.
- Named deal question -> `business-manage-commercial-pipeline`.
- Financial viability -> `business-assess-financial-decision`.
- Planning baseline effect -> `business-build-driver-based-plan-and-forecast`.
- Service burden or delivery feasibility -> `business-improve-operating-process`
  or `business-direct-project-delivery`.
