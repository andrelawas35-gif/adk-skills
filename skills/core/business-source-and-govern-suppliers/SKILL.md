---
name: business-source-and-govern-suppliers
default_tier: high
...
Apply the `business-source-and-govern-suppliers` profile in
...
- Spend viability -> `business-assess-financial-decision`.
- Internal capacity alternative -> `business-plan-workforce-accountability`.
- Supplier-process integration -> `business-improve-operating-process`.
