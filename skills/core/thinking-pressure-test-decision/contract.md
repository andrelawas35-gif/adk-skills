<!--
Lean authoring pilot extension (WO 2026-08-25-005). This file is the
authored contract source used by tools/generate-adapters.py
(--check-core-assembly) to reassemble the current thinking-pressure-test-decision
SKILL.md for byte-identical comparison. Nothing reads this file at runtime yet;
SKILL.md remains the live source until a separate accepted decision cuts over.
-->
...
Apply the `pressure-test-decision` profile and continuous Grilling Session in
