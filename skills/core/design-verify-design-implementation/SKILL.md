...
- A confirmed proposal from `apply-design-direction` (the `[system:design-direction]`
  evidence entry).
...
`apply-design-direction`. Extract the confirmed interpretation: what was
