...
Apply the `apply-design-direction` profile and continuous Grilling Session
...
**Route when:**
- Path A executed — route to `verify-design-implementation` for verification.
- Path B executed — route to `verify-design-implementation` for verification
