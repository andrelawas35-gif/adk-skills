---
name: alawas-verify-release-evidence
description: "alawas-verify-release-evidence — GitHub Copilot adapter"
...
**Preconditions:** `alawas-implement-bounded-change` has completed or honestly routed
...
boundary is missing, stop and route to `alawas-conduct-work-object`; do not select a
...
Apply the `alawas-verify-release-evidence` profile and continuous Grilling Session in
...
failed assumptions, and explicit gaps through `alawas-conduct-work-object`. State
...
This skill does not mutate a Work Object directly. Pass `alawas-conduct-work-object`
