...
description: "deploy-with-recovery — GitHub Copilot adapter"
...
Apply the `deploy-with-recovery` lens in
...
- **Increment verified:** route to `conduct-work-object` for `observe` with
