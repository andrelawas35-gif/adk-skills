...
description: "alawas-implement-bounded-change — GitHub Copilot adapter"
...
**Preconditions:** `alawas-conduct-work-object` has established the Work Object and
...
deviation record to `alawas-conduct-work-object` containing the original constraint,
...
criteria. Route a verified bounded result to `alawas-conduct-work-object` for durable
...
authorized deviation, pass `alawas-conduct-work-object` a concise record containing:
