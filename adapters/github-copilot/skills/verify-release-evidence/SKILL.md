...
description: "verify-release-evidence — GitHub Copilot adapter"
...
**Preconditions:** `implement-bounded-change` has completed or honestly routed
...
boundary is missing, stop and route to `conduct-work-object`; do not select a
...
failed assumptions, and explicit gaps through `conduct-work-object`. State
...
This skill does not mutate a Work Object directly. Pass `conduct-work-object`
