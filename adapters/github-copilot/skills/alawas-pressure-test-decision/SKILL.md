...
description: "alawas-pressure-test-decision — GitHub Copilot adapter"
...
Apply the `alawas-pressure-test-decision` profile and continuous Grilling Session in
...
context. Either `alawas-conduct-work-object` routes here, or the user invokes
directly.
...
**Route back to `alawas-conduct-work-object` when:**
