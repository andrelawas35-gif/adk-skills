...
**Preconditions:** `alawas-audit-product-interface` or `alawas-build-design-foundation` has
...
Apply the `alawas-apply-design-direction` profile and continuous Grilling Session
...
**Route when:**
- Changes executed — route to `alawas-verify-design-implementation` for verification.
