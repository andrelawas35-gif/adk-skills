---
name: alawas-maintain-working-method
description: "alawas-maintain-working-method — GitHub Copilot adapter"
...
Apply the `alawas-maintain-working-method` profile and continuous Grilling Session in
...
confirmation, route to `alawas-conduct-work-object` to create a separate, linked,
...
Return a concise record to `alawas-conduct-work-object` containing the candidate
...
- **Candidate created or updated:** route the bounded record to
  `alawas-conduct-work-object`; do not apply the rule.
...
- **Promotion accepted:** route to `alawas-conduct-work-object` for a separate,
