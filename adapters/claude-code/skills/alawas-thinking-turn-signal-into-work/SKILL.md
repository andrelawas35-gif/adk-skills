---
name: alawas-thinking-turn-signal-into-work
...
Apply the `alawas-thinking-turn-signal-into-work` profile and continuous Grilling Session in
...
`alawas-governance-conduct-work-object` with the captured signal, relevant evidence, proposed
...
- **Remember or incubate:** report the durable entry and revisit trigger, then
  stop.
- **Activate:** route to `alawas-governance-conduct-work-object`.
