---
name: alawas-thinking-pressure-test-decision
...
route a cheaper discriminating experiment to `alawas-design-design-tracer-bullet` when it is
more informative than continued discussion. The engine, not this skill,
controls turn order, continuity, and convergence.

## Skill Grilling Profile

Apply the `alawas-thinking-pressure-test-decision` profile and continuous Grilling Session in
...
context. Either `alawas-governance-conduct-work-object` routes here, or the user invokes
directly.
...
**Route back to `alawas-governance-conduct-work-object` when:**
