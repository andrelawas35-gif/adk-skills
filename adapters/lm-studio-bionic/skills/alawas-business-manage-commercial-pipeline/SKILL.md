---
name: alawas-business-manage-commercial-pipeline
...
Apply the `alawas-business-manage-commercial-pipeline` profile in
...
action, authority needs, and revisit trigger to `alawas-governance-conduct-work-object`.

## Routing and termination

- Financial viability question → `alawas-business-assess-financial-decision`.
- Delivery/process feasibility question → `alawas-business-improve-operating-process`.
