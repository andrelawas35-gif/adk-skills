...
| `background_processes` | `bash (background)` | native |
...
- **Note**: OpenCode does not expose a dedicated artifact-rendering surface for generated skill output. Render deliverables via the document/file workflow or manual steps.
