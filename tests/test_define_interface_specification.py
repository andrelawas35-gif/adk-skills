"""Contract tests for the interface specification skill."""
...
CORE = ROOT / "skills" / "core" / "define-interface-specification" / "SKILL.md"
PLATFORMS = ("codex", "claude-code", "github-copilot")


class DefineInterfaceSpecificationContract(unittest.TestCase):
    def test_core_skill_produces_machine_readable_yaml_specifications(self):
        text = CORE.read_text()
    ...
    def test_generated_adapters_preserve_core_and_include_references(self):
        ...
        for platform in PLATFORMS:
            with self.subTest(platform=platform):
                adapter_dir = ROOT / "adapters" / platform / "skills" / "alawas-define-interface-specification"
