"""Contract tests for the design-to-code connection skill."""
...
CORE = ROOT / "skills" / "core" / "connect-design-to-code" / "SKILL.md"
PLATFORMS = ("codex", "claude-code", "github-copilot")


class ConnectDesignToCodeContract(unittest.TestCase):
    def test_core_skill_maintains_component_registry(self):
        text = CORE.read_text()
        ...
        for required_clause in (
            ...
            "component registry",
            "design/components/registry.yaml",
            "Figwright",
            "component_map",
            "append-and-update",
            "ADR 0028",
    ...
    def test_generated_adapters_preserve_core_and_include_references(self):
        ...
        for platform in PLATFORMS:
            with self.subTest(platform=platform):
                adapter_dir = ROOT / "adapters" / platform / "skills" / "alawas-connect-design-to-code"
