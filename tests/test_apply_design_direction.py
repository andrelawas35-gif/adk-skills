"""Contract tests for the design direction skill."""
...
CORE = ROOT / "skills" / "core" / "design-apply-design-direction" / "SKILL.md"
    ...
    def test_generated_adapters_preserve_core_and_include_references(self):
        ...
        for platform in PLATFORMS:
            with self.subTest(platform=platform):
                adapter_dir = ROOT / "adapters" / platform / "skills" / "alawas-apply-design-direction"
