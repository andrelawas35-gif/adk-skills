"""Contract tests for the Figma rendering skill."""
...
CORE = ROOT / "skills" / "core" / "render-to-figma" / "SKILL.md"
PLATFORMS = ("codex", "claude-code", "github-copilot")


class RenderToFigmaContract(unittest.TestCase):
    def test_core_skill_wraps_figwright_with_governance(self):
        text = CORE.read_text()
    ...
    def test_generated_adapters_preserve_core_and_include_references(self):
        ...
        for platform in PLATFORMS:
            with self.subTest(platform=platform):
                adapter_dir = ROOT / "adapters" / platform / "skills" / "alawas-render-to-figma"
